...
API_KEY = "8cbaf4b112413073b4cce23af5f84b24"  # ← ОБОВʼЯЗКОВО ВСТАВ СВІЙ КЛЮЧ
...
if city:
    try:
        ...
        if data.get("main"):
            ...
            st.error("Не вдалося отримати погоду")
...
complex_choice = st.selectbox(
    "Комплекс",
    ["Комплекс A", "Комплекс B", "Комплекс C"]
)
...
flight_type = st.selectbox(
    "Тип вильоту",
    ["Тренувальний", "Бойовий", "Транспортний"]
)
...
if st.button("💾 Зберегти запис"):
    ...
    st.success("Запис збережено у flight_log.csv")
